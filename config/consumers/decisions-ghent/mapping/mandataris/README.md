...
An overview of the RDF type and properties for **Mandataris** resources from Ghent as made available in https://lokaalbeslist-harvester-1.s.redhost.be.
...
WHERE {
  ...
  ?mandataris ^besluit:heeftVoorzitter ?behandelingVanAgendapunt .
