...
An overview of the RDF type and properties for **Besluit** resources from Ghent as made available in https://lokaalbeslist-harvester-1.s.redhost.be.
...
WHERE {
  ...
  ?besluit ^prov:generated ?behandelingVanAgendapunt .
