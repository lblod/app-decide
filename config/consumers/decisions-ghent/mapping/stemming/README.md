...
An overview of the RDF type and properties for **Stemming** resources from Ghent as made available in https://lokaalbeslist-harvester-1.s.redhost.be.
...
WHERE {
  ...
  ?stemming ^besluit:heeftStemming ?behandelingVanAgendapunt .
