...
An overview of the RDF type and properties for **Agendapunt** resources from Ghent as made available in https://lokaalbeslist-harvester-1.s.redhost.be.
...
WHERE {
  ...
  ?agendapunt ^besluit:behandelt / besluit:isGehoudenDoor ?bestuursorgaan .
